...
int main(int argc, char **argv)
{
    ...
    fprintf(2, "[%s] %s\n", result ? "FAILED" : "OK", "test_multi_context");
     ...
     15e:	dfe78793          	addi	a5,a5,-514 # 1f58 <schedule_rm+0x2b4>
     162:	a029                	j	16c <main+0x3a>
     164:	00002797          	auipc	a5,0x2
     168:	dfc78793          	addi	a5,a5,-516 # 1f60 <schedule_rm+0x2bc>
     16c:	00002697          	auipc	a3,0x2
     170:	dfc68693          	addi	a3,a3,-516 # 1f68 <schedule_rm+0x2c4>
     174:	863e                	mv	a2,a5
     176:	00002597          	auipc	a1,0x2
     17a:	e0a58593          	addi	a1,a1,-502 # 1f80 <schedule_rm+0x2dc>
     17e:	4509                	li	a0,2
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a24:	57078793          	addi	a5,a5,1392 # 1f90 <schedule_rm+0x2ec>
...
void thread_exit(void)
{
    ...
    12e2:	cba58593          	addi	a1,a1,-838 # 1f98 <schedule_rm+0x2f4>
    12e6:	4509                	li	a0,2
...
void __finish_current()
{
    ...
    13ba:	c1a50513          	addi	a0,a0,-998 # 1fd0 <schedule_rm+0x32c>
...
void switch_handler(void *arg)
{
    ...
    14f2:	b1a50513          	addi	a0,a0,-1254 # 2008 <schedule_rm+0x364>
...
void __dispatch()
{
    ...
    15a8:	a6450513          	addi	a0,a0,-1436 # 2008 <schedule_rm+0x364>
    ...
    15e0:	a5450513          	addi	a0,a0,-1452 # 2030 <schedule_rm+0x38c>
    ...
    1696:	9ce58593          	addi	a1,a1,-1586 # 2060 <schedule_rm+0x3bc>
    169a:	4509                	li	a0,2
...
void __schedule(void)
{
    ...
    1728:	580080e7          	jalr	1408(ra) # 1ca4 <schedule_rm>
    172c:	872a                	mv	a4,a0
    172e:	87ae                	mv	a5,a1
...
void thread_start_threading()
{
    ...
    187e:	81e50513          	addi	a0,a0,-2018 # 2098 <schedule_rm+0x3f4>
...
{
    19ce:	7135                	addi	sp,sp,-160
    19d0:	ed22                	sd	s0,152(sp)
    19d2:	e926                	sd	s1,144(sp)
    19d4:	1100                	addi	s0,sp,160
    19d6:	84aa                	mv	s1,a0
    struct threads_sched_result r;

    if(args.run_queue->next != args.run_queue){ // Check whether run queue is empty or not.
    19d8:	649c                	ld	a5,8(s1)
    19da:	6398                	ld	a4,0(a5)
    19dc:	649c                	ld	a5,8(s1)
    19de:	20f70e63          	beq	a4,a5,1bfa <schedule_edf+0x22c>
        struct thread *missed_thread = NULL;
    19e2:	fe043423          	sd	zero,-24(s0)
        struct thread *thread_with_earliest_deadline_in_run_queue = NULL;
    19e6:	fe043023          	sd	zero,-32(s0)
        struct thread *th1 = NULL;
    19ea:	fc043c23          	sd	zero,-40(s0)
        list_for_each_entry(th1, args.run_queue, thread_list) {
    19ee:	649c                	ld	a5,8(s1)
    19f0:	639c                	ld	a5,0(a5)
    19f2:	faf43023          	sd	a5,-96(s0)
    19f6:	fa043783          	ld	a5,-96(s0)
    19fa:	fd878793          	addi	a5,a5,-40
    19fe:	fcf43c23          	sd	a5,-40(s0)
    1a02:	a041                	j	1a82 <schedule_edf+0xb4>
            if (th1->current_deadline < args.current_time && 
    1a04:	fd843783          	ld	a5,-40(s0)
    1a08:	4bb8                	lw	a4,80(a5)
    1a0a:	409c                	lw	a5,0(s1)
    1a0c:	02f75163          	bge	a4,a5,1a2e <schedule_edf+0x60>
    1a10:	fe843783          	ld	a5,-24(s0)
    1a14:	cb89                	beqz	a5,1a26 <schedule_edf+0x58>
                (missed_thread == NULL || 
                    th1->ID <= missed_thread->ID)
    1a16:	fd843783          	ld	a5,-40(s0)
    1a1a:	5398                	lw	a4,32(a5)
    1a1c:	fe843783          	ld	a5,-24(s0)
    1a20:	539c                	lw	a5,32(a5)
                (missed_thread == NULL || 
    1a22:	00e7c663          	blt	a5,a4,1a2e <schedule_edf+0x60>
                ) {
                    missed_thread = th1;
    1a26:	fd843783          	ld	a5,-40(s0)
    1a2a:	fef43423          	sd	a5,-24(s0)
            }

            if (thread_with_earliest_deadline_in_run_queue == NULL || 
    1a2e:	fe043783          	ld	a5,-32(s0)
    1a32:	cb8d                	beqz	a5,1a64 <schedule_edf+0x96>
    ...
    1a3e:	4bbc                	lw	a5,80(a5)
            if (thread_with_earliest_deadline_in_run_queue == NULL || 
    1a40:	02f74263          	blt	a4,a5,1a64 <schedule_edf+0x96>
                (th1->current_deadline == thread_with_earliest_deadline_in_run_queue->current_deadline && 
    1a44:	fd843783          	ld	a5,-40(s0)
    1a48:	4bb8                	lw	a4,80(a5)
    1a4a:	fe043783          	ld	a5,-32(s0)
    1a4e:	4bbc                	lw	a5,80(a5)
                th1->current_deadline < thread_with_earliest_deadline_in_run_queue->current_deadline || 
    1a50:	00f71e63          	bne	a4,a5,1a6c <schedule_edf+0x9e>
                    th1->ID < thread_with_earliest_deadline_in_run_queue->ID)
    1a54:	fd843783          	ld	a5,-40(s0)
    1a58:	5398                	lw	a4,32(a5)
    1a5a:	fe043783          	ld	a5,-32(s0)
    1a5e:	539c                	lw	a5,32(a5)
                (th1->current_deadline == thread_with_earliest_deadline_in_run_queue->current_deadline && 
    1a60:	00f75663          	bge	a4,a5,1a6c <schedule_edf+0x9e>
                ) {
    ...
    1a68:	fef43023          	sd	a5,-32(s0)
        list_for_each_entry(th1, args.run_queue, thread_list) {
    1a6c:	fd843783          	ld	a5,-40(s0)
    1a70:	779c                	ld	a5,40(a5)
    1a72:	f8f43423          	sd	a5,-120(s0)
    1a76:	f8843783          	ld	a5,-120(s0)
    1a7a:	fd878793          	addi	a5,a5,-40
    1a7e:	fcf43c23          	sd	a5,-40(s0)
    1a82:	fd843783          	ld	a5,-40(s0)
    1a86:	02878713          	addi	a4,a5,40
    1a8a:	649c                	ld	a5,8(s1)
    1a8c:	f6f71ce3          	bne	a4,a5,1a04 <schedule_edf+0x36>
            }
        }

        if(missed_thread != NULL){
    1a90:	fe843783          	ld	a5,-24(s0)
    1a94:	c395                	beqz	a5,1ab8 <schedule_edf+0xea>
            r.scheduled_thread_list_member = &missed_thread->thread_list;
    1a96:	fe843783          	ld	a5,-24(s0)
    1a9a:	02878793          	addi	a5,a5,40
    1a9e:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0;
    1aa2:	f6042823          	sw	zero,-144(s0)
            return r;
    1aa6:	f6843783          	ld	a5,-152(s0)
    1aaa:	f6f43c23          	sd	a5,-136(s0)
    1aae:	f7043783          	ld	a5,-144(s0)
    1ab2:	f8f43023          	sd	a5,-128(s0)
    1ab6:	aac9                	j	1c88 <schedule_edf+0x2ba>
        }

        struct thread *thread_with_earliest_deadline_in_release_queue = NULL;
    1ab8:	fc043823          	sd	zero,-48(s0)
        struct release_queue_entry *th2 = NULL;
    1abc:	fc043423          	sd	zero,-56(s0)
        list_for_each_entry(th2, args.release_queue, thread_list) {
    1ac0:	689c                	ld	a5,16(s1)
    1ac2:	639c                	ld	a5,0(a5)
    1ac4:	f8f43c23          	sd	a5,-104(s0)
    1ac8:	f9843783          	ld	a5,-104(s0)
    1acc:	17e1                	addi	a5,a5,-8
    1ace:	fcf43423          	sd	a5,-56(s0)
    1ad2:	a055                	j	1b76 <schedule_edf+0x1a8>
            if ((th2->thrd->current_deadline + th2->thrd->period < thread_with_earliest_deadline_in_run_queue->current_deadline ||
    1ad4:	fc843783          	ld	a5,-56(s0)
    1ad8:	639c                	ld	a5,0(a5)
    1ada:	4bb8                	lw	a4,80(a5)
    1adc:	fc843783          	ld	a5,-56(s0)
    1ae0:	639c                	ld	a5,0(a5)
    1ae2:	43fc                	lw	a5,68(a5)
    1ae4:	9fb9                	addw	a5,a5,a4
    1ae6:	0007871b          	sext.w	a4,a5
    1aea:	fe043783          	ld	a5,-32(s0)
    1aee:	4bbc                	lw	a5,80(a5)
    1af0:	02f74b63          	blt	a4,a5,1b26 <schedule_edf+0x158>
    ...
    1afa:	4bb8                	lw	a4,80(a5)
    1afc:	fc843783          	ld	a5,-56(s0)
    1b00:	639c                	ld	a5,0(a5)
    1b02:	43fc                	lw	a5,68(a5)
    1b04:	9fb9                	addw	a5,a5,a4
    1b06:	0007871b          	sext.w	a4,a5
    1b0a:	fe043783          	ld	a5,-32(s0)
    1b0e:	4bbc                	lw	a5,80(a5)
            if ((th2->thrd->current_deadline + th2->thrd->period < thread_with_earliest_deadline_in_run_queue->current_deadline ||
    1b10:	04f71963          	bne	a4,a5,1b62 <schedule_edf+0x194>
    ...
    1b20:	539c                	lw	a5,32(a5)
                    (th2->thrd->current_deadline + th2->thrd->period == thread_with_earliest_deadline_in_run_queue->current_deadline && 
    1b22:	04f75063          	bge	a4,a5,1b62 <schedule_edf+0x194>
                        th2->thrd->ID < thread_with_earliest_deadline_in_release_queue->ID)) &&
    1b26:	fd043783          	ld	a5,-48(s0)
    1b2a:	c79d                	beqz	a5,1b58 <schedule_edf+0x18a>
    ...
    1b30:	639c                	ld	a5,0(a5)
    1b32:	4bb8                	lw	a4,80(a5)
    1b34:	fc843783          	ld	a5,-56(s0)
    1b38:	639c                	ld	a5,0(a5)
    1b3a:	43fc                	lw	a5,68(a5)
    1b3c:	9fb9                	addw	a5,a5,a4
    1b3e:	0007859b          	sext.w	a1,a5
    1b42:	fd043783          	ld	a5,-48(s0)
    1b46:	4bb8                	lw	a4,80(a5)
    1b48:	fd043783          	ld	a5,-48(s0)
    1b4c:	43fc                	lw	a5,68(a5)
    1b4e:	9fb9                	addw	a5,a5,a4
    1b50:	2781                	sext.w	a5,a5
                (thread_with_earliest_deadline_in_release_queue == NULL ||
    1b52:	872e                	mv	a4,a1
    1b54:	00f75763          	bge	a4,a5,1b62 <schedule_edf+0x194>
                ) {
    ...
    1b66:	679c                	ld	a5,8(a5)
    1b68:	f8f43823          	sd	a5,-112(s0)
    1b6c:	f9043783          	ld	a5,-112(s0)
    1b70:	17e1                	addi	a5,a5,-8
    1b72:	fcf43423          	sd	a5,-56(s0)
    1b76:	fc843783          	ld	a5,-56(s0)
    1b7a:	00878713          	addi	a4,a5,8
    1b7e:	689c                	ld	a5,16(s1)
    1b80:	f4f71ae3          	bne	a4,a5,1ad4 <schedule_edf+0x106>
            }
        }
    ...
    1b96:	fe043783          	ld	a5,-32(s0)
    1b9a:	4bb8                	lw	a4,80(a5)
    1b9c:	409c                	lw	a5,0(s1)
    1b9e:	40f707bb          	subw	a5,a4,a5
    1ba2:	0007871b          	sext.w	a4,a5
    1ba6:	fe043783          	ld	a5,-32(s0)
    1baa:	47fc                	lw	a5,76(a5)
    1bac:	853e                	mv	a0,a5
    1bae:	85ba                	mv	a1,a4
    1bb0:	0005871b          	sext.w	a4,a1
    1bb4:	0005079b          	sext.w	a5,a0
    1bb8:	00e7d363          	bge	a5,a4,1bbe <schedule_edf+0x1f0>
    1bbc:	85aa                	mv	a1,a0
    1bbe:	0005879b          	sext.w	a5,a1
    1bc2:	f6f42823          	sw	a5,-144(s0)
    1bc6:	a84d                	j	1c78 <schedule_edf+0x2aa>
        }
        else{
    ...
    1bcc:	4bb8                	lw	a4,80(a5)
    1bce:	409c                	lw	a5,0(s1)
    1bd0:	40f707bb          	subw	a5,a4,a5
    1bd4:	0007871b          	sext.w	a4,a5
    1bd8:	fe043783          	ld	a5,-32(s0)
    1bdc:	47fc                	lw	a5,76(a5)
    1bde:	853e                	mv	a0,a5
    1be0:	85ba                	mv	a1,a4
    1be2:	0005871b          	sext.w	a4,a1
    1be6:	0005079b          	sext.w	a5,a0
    1bea:	00e7d363          	bge	a5,a4,1bf0 <schedule_edf+0x222>
    1bee:	85aa                	mv	a1,a0
    1bf0:	0005879b          	sext.w	a5,a1
    1bf4:	f6f42823          	sw	a5,-144(s0)
    1bf8:	a041                	j	1c78 <schedule_edf+0x2aa>
        }
        
    }
    else{
        struct release_queue_entry *entry_with_earliest_release_time = NULL;
    1bfa:	fc043023          	sd	zero,-64(s0)
        struct release_queue_entry *th = NULL;
    1bfe:	fa043c23          	sd	zero,-72(s0)
        list_for_each_entry(th, args.release_queue, thread_list) {
    1c02:	689c                	ld	a5,16(s1)
    1c04:	639c                	ld	a5,0(a5)
    1c06:	faf43823          	sd	a5,-80(s0)
    1c0a:	fb043783          	ld	a5,-80(s0)
    1c0e:	17e1                	addi	a5,a5,-8
    1c10:	faf43c23          	sd	a5,-72(s0)
    1c14:	a815                	j	1c48 <schedule_edf+0x27a>
            if (entry_with_earliest_release_time == NULL || 
    1c16:	fc043783          	ld	a5,-64(s0)
    1c1a:	cb89                	beqz	a5,1c2c <schedule_edf+0x25e>
                th->release_time < entry_with_earliest_release_time->release_time
    1c1c:	fb843783          	ld	a5,-72(s0)
    1c20:	4f98                	lw	a4,24(a5)
    1c22:	fc043783          	ld	a5,-64(s0)
    1c26:	4f9c                	lw	a5,24(a5)
            if (entry_with_earliest_release_time == NULL || 
    1c28:	00f75663          	bge	a4,a5,1c34 <schedule_edf+0x266>
                ) {

                entry_with_earliest_release_time = th;
    1c2c:	fb843783          	ld	a5,-72(s0)
    1c30:	fcf43023          	sd	a5,-64(s0)
        list_for_each_entry(th, args.release_queue, thread_list) {
    1c34:	fb843783          	ld	a5,-72(s0)
    1c38:	679c                	ld	a5,8(a5)
    1c3a:	faf43423          	sd	a5,-88(s0)
    1c3e:	fa843783          	ld	a5,-88(s0)
    1c42:	17e1                	addi	a5,a5,-8
    1c44:	faf43c23          	sd	a5,-72(s0)
    1c48:	fb843783          	ld	a5,-72(s0)
    1c4c:	00878713          	addi	a4,a5,8
    1c50:	689c                	ld	a5,16(s1)
    1c52:	fcf712e3          	bne	a4,a5,1c16 <schedule_edf+0x248>
            }
        }
        
        r.scheduled_thread_list_member = args.run_queue;
    1c56:	649c                	ld	a5,8(s1)
    1c58:	f6f43423          	sd	a5,-152(s0)
    ...
    1c60:	cb89                	beqz	a5,1c72 <schedule_edf+0x2a4>
    1c62:	fc043783          	ld	a5,-64(s0)
    1c66:	4f98                	lw	a4,24(a5)
    1c68:	409c                	lw	a5,0(s1)
    1c6a:	40f707bb          	subw	a5,a4,a5
    1c6e:	2781                	sext.w	a5,a5
    1c70:	a011                	j	1c74 <schedule_edf+0x2a6>
    1c72:	4785                	li	a5,1
    1c74:	f6f42823          	sw	a5,-144(s0)
    }
    
    return r;
    1c78:	f6843783          	ld	a5,-152(s0)
    1c7c:	f6f43c23          	sd	a5,-136(s0)
    1c80:	f7043783          	ld	a5,-144(s0)
    1c84:	f8f43023          	sd	a5,-128(s0)
}
    1c88:	f7843703          	ld	a4,-136(s0)
    1c8c:	f8043783          	ld	a5,-128(s0)
    1c90:	863a                	mv	a2,a4
    1c92:	86be                	mv	a3,a5
    1c94:	8732                	mv	a4,a2
    1c96:	87b6                	mv	a5,a3
    1c98:	853a                	mv	a0,a4
    1c9a:	85be                	mv	a1,a5
    1c9c:	646a                	ld	s0,152(sp)
    1c9e:	64ca                	ld	s1,144(sp)
    1ca0:	610d                	addi	sp,sp,160
    1ca2:	8082                	ret

0000000000001ca4 <schedule_rm>:

/* Rate-Monotonic Scheduling */
struct threads_sched_result schedule_rm(struct threads_sched_args args)
{
    1ca4:	7135                	addi	sp,sp,-160
    1ca6:	ed22                	sd	s0,152(sp)
    1ca8:	e926                	sd	s1,144(sp)
    1caa:	1100                	addi	s0,sp,160
    1cac:	84aa                	mv	s1,a0
    struct threads_sched_result r;

    if(args.run_queue->next != args.run_queue){ // Check whether run queue is empty or not.
    1cae:	649c                	ld	a5,8(s1)
    1cb0:	6398                	ld	a4,0(a5)
    1cb2:	649c                	ld	a5,8(s1)
    1cb4:	1ef70c63          	beq	a4,a5,1eac <schedule_rm+0x208>
        struct thread *missed_thread = NULL;
    1cb8:	fe043423          	sd	zero,-24(s0)
        struct thread *thread_with_shortest_period_in_run_queue = NULL;
    1cbc:	fe043023          	sd	zero,-32(s0)
        struct thread *th1 = NULL;
    1cc0:	fc043c23          	sd	zero,-40(s0)

        list_for_each_entry(th1, args.run_queue, thread_list) {
    1cc4:	649c                	ld	a5,8(s1)
    1cc6:	639c                	ld	a5,0(a5)
    1cc8:	faf43023          	sd	a5,-96(s0)
    1ccc:	fa043783          	ld	a5,-96(s0)
    1cd0:	fd878793          	addi	a5,a5,-40
    1cd4:	fcf43c23          	sd	a5,-40(s0)
    1cd8:	a041                	j	1d58 <schedule_rm+0xb4>
            if (th1->current_deadline <= args.current_time && 
    1cda:	fd843783          	ld	a5,-40(s0)
    1cde:	4bb8                	lw	a4,80(a5)
    1ce0:	409c                	lw	a5,0(s1)
    1ce2:	02e7c163          	blt	a5,a4,1d04 <schedule_rm+0x60>
    1ce6:	fe843783          	ld	a5,-24(s0)
    1cea:	cb89                	beqz	a5,1cfc <schedule_rm+0x58>
                (missed_thread == NULL || 
                    th1->ID < missed_thread->ID)
    1cec:	fd843783          	ld	a5,-40(s0)
    1cf0:	5398                	lw	a4,32(a5)
    1cf2:	fe843783          	ld	a5,-24(s0)
    1cf6:	539c                	lw	a5,32(a5)
                (missed_thread == NULL || 
    1cf8:	00f75663          	bge	a4,a5,1d04 <schedule_rm+0x60>
                ) {
                    missed_thread = th1;
    1cfc:	fd843783          	ld	a5,-40(s0)
    1d00:	fef43423          	sd	a5,-24(s0)
            }
            
            if (thread_with_shortest_period_in_run_queue == NULL || 
    1d04:	fe043783          	ld	a5,-32(s0)
    1d08:	cb8d                	beqz	a5,1d3a <schedule_rm+0x96>
                th1->period < thread_with_shortest_period_in_run_queue->period || 
    1d0a:	fd843783          	ld	a5,-40(s0)
    1d0e:	43f8                	lw	a4,68(a5)
    1d10:	fe043783          	ld	a5,-32(s0)
    1d14:	43fc                	lw	a5,68(a5)
            if (thread_with_shortest_period_in_run_queue == NULL || 
    1d16:	02f74263          	blt	a4,a5,1d3a <schedule_rm+0x96>
                (th1->period == thread_with_shortest_period_in_run_queue->period &&
    1d1a:	fd843783          	ld	a5,-40(s0)
    1d1e:	43f8                	lw	a4,68(a5)
    1d20:	fe043783          	ld	a5,-32(s0)
    1d24:	43fc                	lw	a5,68(a5)
                th1->period < thread_with_shortest_period_in_run_queue->period || 
    1d26:	00f71e63          	bne	a4,a5,1d42 <schedule_rm+0x9e>
                    th1->ID < thread_with_shortest_period_in_run_queue->ID)
    1d2a:	fd843783          	ld	a5,-40(s0)
    1d2e:	5398                	lw	a4,32(a5)
    1d30:	fe043783          	ld	a5,-32(s0)
    1d34:	539c                	lw	a5,32(a5)
                (th1->period == thread_with_shortest_period_in_run_queue->period &&
    1d36:	00f75663          	bge	a4,a5,1d42 <schedule_rm+0x9e>
                ) {
    ...
    1d3e:	fef43023          	sd	a5,-32(s0)
        list_for_each_entry(th1, args.run_queue, thread_list) {
    1d42:	fd843783          	ld	a5,-40(s0)
    1d46:	779c                	ld	a5,40(a5)
    1d48:	f8f43423          	sd	a5,-120(s0)
    1d4c:	f8843783          	ld	a5,-120(s0)
    1d50:	fd878793          	addi	a5,a5,-40
    1d54:	fcf43c23          	sd	a5,-40(s0)
    1d58:	fd843783          	ld	a5,-40(s0)
    1d5c:	02878713          	addi	a4,a5,40
    1d60:	649c                	ld	a5,8(s1)
    1d62:	f6f71ce3          	bne	a4,a5,1cda <schedule_rm+0x36>
            }
        }

        if(missed_thread != NULL){
    1d66:	fe843783          	ld	a5,-24(s0)
    1d6a:	c395                	beqz	a5,1d8e <schedule_rm+0xea>
            r.scheduled_thread_list_member = &missed_thread->thread_list;
    1d6c:	fe843783          	ld	a5,-24(s0)
    1d70:	02878793          	addi	a5,a5,40
    1d74:	f6f43423          	sd	a5,-152(s0)
            r.allocated_time = 0;
    1d78:	f6042823          	sw	zero,-144(s0)
            return r;
    1d7c:	f6843783          	ld	a5,-152(s0)
    1d80:	f6f43c23          	sd	a5,-136(s0)
    1d84:	f7043783          	ld	a5,-144(s0)
    1d88:	f8f43023          	sd	a5,-128(s0)
    1d8c:	a27d                	j	1f3a <schedule_rm+0x296>
        }

        struct thread *thread_with_shortest_period_in_release_queue = NULL;
    1d8e:	fc043823          	sd	zero,-48(s0)
        struct release_queue_entry *th2 = NULL;
    1d92:	fc043423          	sd	zero,-56(s0)

        list_for_each_entry(th2, args.release_queue, thread_list) {
    1d96:	689c                	ld	a5,16(s1)
    1d98:	639c                	ld	a5,0(a5)
    1d9a:	f8f43c23          	sd	a5,-104(s0)
    1d9e:	f9843783          	ld	a5,-104(s0)
    1da2:	17e1                	addi	a5,a5,-8
    1da4:	fcf43423          	sd	a5,-56(s0)
    1da8:	a0bd                	j	1e16 <schedule_rm+0x172>
            if ((th2->thrd->period < thread_with_shortest_period_in_run_queue->period ||
    1daa:	fc843783          	ld	a5,-56(s0)
    1dae:	639c                	ld	a5,0(a5)
    1db0:	43f8                	lw	a4,68(a5)
    1db2:	fe043783          	ld	a5,-32(s0)
    1db6:	43fc                	lw	a5,68(a5)
    1db8:	02f74463          	blt	a4,a5,1de0 <schedule_rm+0x13c>
                    (th2->thrd->period == thread_with_shortest_period_in_run_queue->period &&
    1dbc:	fc843783          	ld	a5,-56(s0)
    1dc0:	639c                	ld	a5,0(a5)
    1dc2:	43f8                	lw	a4,68(a5)
    1dc4:	fe043783          	ld	a5,-32(s0)
    1dc8:	43fc                	lw	a5,68(a5)
            if ((th2->thrd->period < thread_with_shortest_period_in_run_queue->period ||
    1dca:	02f71c63          	bne	a4,a5,1e02 <schedule_rm+0x15e>
                        th2->thrd->ID < thread_with_shortest_period_in_run_queue->ID)) &&
    1dce:	fc843783          	ld	a5,-56(s0)
    1dd2:	639c                	ld	a5,0(a5)
    1dd4:	5398                	lw	a4,32(a5)
    1dd6:	fe043783          	ld	a5,-32(s0)
    1dda:	539c                	lw	a5,32(a5)
                    (th2->thrd->period == thread_with_shortest_period_in_run_queue->period &&
    1ddc:	02f75363          	bge	a4,a5,1e02 <schedule_rm+0x15e>
                        th2->thrd->ID < thread_with_shortest_period_in_run_queue->ID)) &&
    1de0:	fd043783          	ld	a5,-48(s0)
    1de4:	cb91                	beqz	a5,1df8 <schedule_rm+0x154>
    ...
    1dea:	639c                	ld	a5,0(a5)
    1dec:	4bb8                	lw	a4,80(a5)
    1dee:	fd043783          	ld	a5,-48(s0)
    1df2:	4bbc                	lw	a5,80(a5)
                (thread_with_shortest_period_in_release_queue == NULL ||
    1df4:	00f75763          	bge	a4,a5,1e02 <schedule_rm+0x15e>
                ) {

                thread_with_shortest_period_in_release_queue = th2->thrd;
    1df8:	fc843783          	ld	a5,-56(s0)
    1dfc:	639c                	ld	a5,0(a5)
    1dfe:	fcf43823          	sd	a5,-48(s0)
        list_for_each_entry(th2, args.release_queue, thread_list) {
    1e02:	fc843783          	ld	a5,-56(s0)
    1e06:	679c                	ld	a5,8(a5)
    1e08:	f8f43823          	sd	a5,-112(s0)
    1e0c:	f9043783          	ld	a5,-112(s0)
    1e10:	17e1                	addi	a5,a5,-8
    1e12:	fcf43423          	sd	a5,-56(s0)
    1e16:	fc843783          	ld	a5,-56(s0)
    1e1a:	00878713          	addi	a4,a5,8
    1e1e:	689c                	ld	a5,16(s1)
    1e20:	f8f715e3          	bne	a4,a5,1daa <schedule_rm+0x106>
            }
        }

        r.scheduled_thread_list_member = &thread_with_shortest_period_in_run_queue->thread_list;
    1e24:	fe043783          	ld	a5,-32(s0)
    1e28:	02878793          	addi	a5,a5,40
    1e2c:	f6f43423          	sd	a5,-152(s0)
        if (thread_with_shortest_period_in_release_queue == NULL || 
    1e30:	fd043783          	ld	a5,-48(s0)
    1e34:	cb8d                	beqz	a5,1e66 <schedule_rm+0x1c2>
    ...
    1e36:	fe043783          	ld	a5,-32(s0)
    1e3a:	4bac                	lw	a1,80(a5)
    1e3c:	4098                	lw	a4,0(s1)
    1e3e:	fe043783          	ld	a5,-32(s0)
    1e42:	47fc                	lw	a5,76(a5)
    1e44:	9fb9                	addw	a5,a5,a4
    1e46:	2781                	sext.w	a5,a5
    1e48:	853e                	mv	a0,a5
    1e4a:	0005871b          	sext.w	a4,a1
    1e4e:	0005079b          	sext.w	a5,a0
    1e52:	00e7d363          	bge	a5,a4,1e58 <schedule_rm+0x1b4>
    1e56:	85aa                	mv	a1,a0
    1e58:	0005871b          	sext.w	a4,a1
    1e5c:	fd043783          	ld	a5,-48(s0)
    1e60:	4bbc                	lw	a5,80(a5)
        if (thread_with_shortest_period_in_release_queue == NULL || 
    1e62:	02e7cb63          	blt	a5,a4,1e98 <schedule_rm+0x1f4>
            ) {           
    ...
    1e66:	fe043783          	ld	a5,-32(s0)
    1e6a:	4bb8                	lw	a4,80(a5)
    1e6c:	409c                	lw	a5,0(s1)
    1e6e:	40f707bb          	subw	a5,a4,a5
    1e72:	0007871b          	sext.w	a4,a5
    1e76:	fe043783          	ld	a5,-32(s0)
    1e7a:	47fc                	lw	a5,76(a5)
    1e7c:	853e                	mv	a0,a5
    1e7e:	85ba                	mv	a1,a4
    1e80:	0005871b          	sext.w	a4,a1
    1e84:	0005079b          	sext.w	a5,a0
    1e88:	00e7d363          	bge	a5,a4,1e8e <schedule_rm+0x1ea>
    1e8c:	85aa                	mv	a1,a0
    1e8e:	0005879b          	sext.w	a5,a1
    1e92:	f6f42823          	sw	a5,-144(s0)
    1e96:	a851                	j	1f2a <schedule_rm+0x286>
        }
        else{
            r.allocated_time = thread_with_shortest_period_in_release_queue->current_deadline - args.current_time;
    1e98:	fd043783          	ld	a5,-48(s0)
    1e9c:	4bb8                	lw	a4,80(a5)
    1e9e:	409c                	lw	a5,0(s1)
    1ea0:	40f707bb          	subw	a5,a4,a5
    1ea4:	2781                	sext.w	a5,a5
    1ea6:	f6f42823          	sw	a5,-144(s0)
    1eaa:	a041                	j	1f2a <schedule_rm+0x286>
        }
    }
    else{
        struct release_queue_entry *entry_with_earliest_release_time = NULL;
    1eac:	fc043023          	sd	zero,-64(s0)
        struct release_queue_entry *th = NULL;
    1eb0:	fa043c23          	sd	zero,-72(s0)
        list_for_each_entry(th, args.release_queue, thread_list) {
    1eb4:	689c                	ld	a5,16(s1)
    1eb6:	639c                	ld	a5,0(a5)
    1eb8:	faf43823          	sd	a5,-80(s0)
    1ebc:	fb043783          	ld	a5,-80(s0)
    1ec0:	17e1                	addi	a5,a5,-8
    1ec2:	faf43c23          	sd	a5,-72(s0)
    1ec6:	a815                	j	1efa <schedule_rm+0x256>
            if (entry_with_earliest_release_time == NULL || 
    1ec8:	fc043783          	ld	a5,-64(s0)
    1ecc:	cb89                	beqz	a5,1ede <schedule_rm+0x23a>
                th->release_time < entry_with_earliest_release_time->release_time
    1ece:	fb843783          	ld	a5,-72(s0)
    1ed2:	4f98                	lw	a4,24(a5)
    1ed4:	fc043783          	ld	a5,-64(s0)
    1ed8:	4f9c                	lw	a5,24(a5)
            if (entry_with_earliest_release_time == NULL || 
    1eda:	00f75663          	bge	a4,a5,1ee6 <schedule_rm+0x242>
                ) {

                entry_with_earliest_release_time = th;
    1ede:	fb843783          	ld	a5,-72(s0)
    1ee2:	fcf43023          	sd	a5,-64(s0)
        list_for_each_entry(th, args.release_queue, thread_list) {
    1ee6:	fb843783          	ld	a5,-72(s0)
    1eea:	679c                	ld	a5,8(a5)
    1eec:	faf43423          	sd	a5,-88(s0)
    1ef0:	fa843783          	ld	a5,-88(s0)
    1ef4:	17e1                	addi	a5,a5,-8
    1ef6:	faf43c23          	sd	a5,-72(s0)
    1efa:	fb843783          	ld	a5,-72(s0)
    1efe:	00878713          	addi	a4,a5,8
    1f02:	689c                	ld	a5,16(s1)
    1f04:	fcf712e3          	bne	a4,a5,1ec8 <schedule_rm+0x224>
            }
        }
        
        r.scheduled_thread_list_member = args.run_queue;
    1f08:	649c                	ld	a5,8(s1)
    1f0a:	f6f43423          	sd	a5,-152(s0)
        r.allocated_time = entry_with_earliest_release_time == NULL? 1 : entry_with_earliest_release_time->release_time - args.current_time;
    1f0e:	fc043783          	ld	a5,-64(s0)
    1f12:	cb89                	beqz	a5,1f24 <schedule_rm+0x280>
    1f14:	fc043783          	ld	a5,-64(s0)
    1f18:	4f98                	lw	a4,24(a5)
    1f1a:	409c                	lw	a5,0(s1)
    1f1c:	40f707bb          	subw	a5,a4,a5
    1f20:	2781                	sext.w	a5,a5
    1f22:	a011                	j	1f26 <schedule_rm+0x282>
    1f24:	4785                	li	a5,1
    1f26:	f6f42823          	sw	a5,-144(s0)
    }

    return r;
    1f2a:	f6843783          	ld	a5,-152(s0)
    1f2e:	f6f43c23          	sd	a5,-136(s0)
    1f32:	f7043783          	ld	a5,-144(s0)
    1f36:	f8f43023          	sd	a5,-128(s0)
}
    1f3a:	f7843703          	ld	a4,-136(s0)
    1f3e:	f8043783          	ld	a5,-128(s0)
    1f42:	863a                	mv	a2,a4
    1f44:	86be                	mv	a3,a5
    1f46:	8732                	mv	a4,a2
    1f48:	87b6                	mv	a5,a3
    1f4a:	853a                	mv	a0,a4
    1f4c:	85be                	mv	a1,a5
    1f4e:	646a                	ld	s0,152(sp)
    1f50:	64ca                	ld	s1,144(sp)
    1f52:	610d                	addi	sp,sp,160
    1f54:	8082                	ret
